...
const AlternatingText = ({ slice }: AlternatingTextProps): JSX.Element => {
  return (
    <Bounded
      ...
      >
      <div 
    className="alternating-text-container bg-radial-burst-dynamic"
    style={{
      ['--radial-bg' as string]: 'rgba(44, 194, 86, 0.8)',
      ['--conic-color1' as string]: '#008F3D',
      ['--conic-color2' as string]: '#7BE89C'
